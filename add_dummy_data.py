...
def create_dummy_data(count=1000):
    """
    ...
    with app.app_context():
        ...
        for i in range(start_index, start_index + count):
            ...
            # Gunakan db.session.add() untuk setiap objek MwsPart.
            # SQLAlchemy akan secara otomatis menangani penyimpanan MwsStep yang terkait.
